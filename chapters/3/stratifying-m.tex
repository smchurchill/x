...
\begin{proof}[Proof of Theorem \ref{thm:block-structure}]
	...
	Interactive blocks occur only over our octagonal vertex regions, and each vertex region was created by fitting with an octagon around an intersection of $X_f$.
