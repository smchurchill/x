...
\begin{proof}
	...
	Giving the fiber the natural graph structure implied by the figure, there is a clear handlebody structure.
	The base manifold is either a single (3,0)--handle, in the case of a single critical point, or a pair of disconnected (3,0)--handles in the case of two.
	Each edge then corresponds to a (3,1)--handle.
	Let $\alpha_i$ be the meridians found as the belt spheres of each (3,1)--handle.
	...
	Thus $V'$ is a (3,2)--handlebody, and $V''$ is a 3--sphere.
