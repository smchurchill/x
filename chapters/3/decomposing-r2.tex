...
%		and this forms an alternating pattern.
%		Note that the 1--strata vertex sleeves alternate between containing exactly one singular value,  or consisting entirely of regular values.
