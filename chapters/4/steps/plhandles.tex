...
\begin{algorithm}[h!]
	...
	\Begin{
		...
		$M$ is a polyhedral gluing, so we replace $M$ with the triangulation obtained from this gluing via barycentric subdivision\;
		Construct $W$, the 4--manifold triangulation $M\times I$ obtained by gluing a triangulated 4--prism to each tetrahedron of $M$\;
