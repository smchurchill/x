...
When all handles have been attached, we are left with a cell complex whose only boundary component is $M$, and the entire complex is subdivided into a triangulation.
