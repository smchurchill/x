...
\begin{algorithm}[h!]
	...
	\KwResult{A closed, orientable 3--manifold triangulation that is a subdivision of $N'$}
	\Begin{
		\ForEach{polyhedral 3--cell $\tau$ of $N'$ that is not a tetrahedron}{
			Replace $\tau$ with the cone on $\pd \tau$\;
		}
		\ForEach{polygonal 2--cell $\delta$ of $N'$ that is not a triangle}{
