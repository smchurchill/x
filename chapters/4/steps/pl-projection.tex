...
algorithm (cite) also projects each top dimensional simplex of N in standard position in The plane (include figure).  edges of N Not on sigma are pieces transversely to Sigma, forming live segments in the protected simplex.
The Primavera of these lines are tris and quads nside of sigma, and we use tgese to deconpose the top lecel simpkices.
